...
namespace LinkedInClone.Data.Migrations
{
    ...
    [Migration("20230201203311_CreateCommentsUpdateLikes")]
    partial class CreateCommentsUpdateLikes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinkedInClone.Models.Connection", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "AccountOwner")
                        .WithMany()
            ...
            modelBuilder.Entity("LinkedInClone.Models.Like", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "LikedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("LinkedInClone.Models.Message", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "ReceivedUser")
                        .WithMany()
                        .HasForeignKey("ReceivedUserId");

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "SentBy")
                        .WithMany()
